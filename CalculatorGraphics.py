...
def checkInput(inp):
    while True:
        if 1 > inp.getX() >= 0 and 1 > inp.getY() >= 0:
            ...
            return "."
        elif inp.getX() >= 3 and 1 > inp.getY() >= 0:
            return "="
            ...
            return "3"
        elif inp.getX() >= 3 and 2 > inp.getY() >= 1:
            return "+"
            ...
            return "6"
        elif inp.getX() >= 3 and 3 > inp.getY() >= 2:
            return "-"
            ...
            return "9"
        elif inp.getX() >= 3 and 3 <= inp.getY() < 4:
            return "*"
        elif inp.getX() >= 3 and inp.getY() >= 4:
            return "/"
